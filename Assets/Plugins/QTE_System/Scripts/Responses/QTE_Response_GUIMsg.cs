...
public class QTE_Response_GUIMsg : MonoBehaviour
{
	...
	void CreateTexture (float xVal, float yVal)
	{
		...
		//ResultTexture.transform.localPosition = new Vector3(xVal,yVal,0);
		//ResultTexture.transform.localScale = new Vector3(0,0,1);
		//ResultTexture.AddComponent<GUITexture>();
