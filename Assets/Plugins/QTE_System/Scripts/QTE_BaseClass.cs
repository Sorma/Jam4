/* Both QTE_Main.cs and QTE_Trigger inherit from this base class because they both need a copy of these values. So that the Trigger can store them per trigger, and pass it off to the main script */
using UnityEngine;
...
public class QTE_BaseClass : MonoBehaviour
{
    ...
    /*
[HideInInspector]
public float TouchHoldTime = 1.0f;
[HideInInspector]
public float TouchHoldTime2 = 1.0f;
[HideInInspector]
public float TouchHoldTime3 = 1.0f;
[HideInInspector]
public float TouchHoldTime4 = 1.0f;
[HideInInspector]
public int[] SwipeDirectionChoices = new int[4];
    ...
    public string[] SwipeDirections = new string[]{"Up", "Down", "Left", "Right"};
